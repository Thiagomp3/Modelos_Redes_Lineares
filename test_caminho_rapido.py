from caminho_rapido import solve_model
def main():
    import sys
    import tableutils
    n=10
    ...
    if len(sys.argv)<=1:
        ...
        return
    C=[[0,20,0,12,0,0,0,0,0,0],
       [20,0,18,0,0,0,0,18,0,0],
       [0,18,0,32,0,28,0,0,25,0],
       [12,0,32,0,18,0,0,0,0,0],
       [0,0,0,18,0,30,13,0,0,0],
       [0,0,28,0,30,0,0,0,21,49],
       [0,0,0,0,13,0,0,0,0,38],
       [0,18,0,0,0,0,0,0,36,28],
       [0,0,25,0,0,21,0,36,0,40],
       [0,0,0,0,0,49,38,28,40,0]]
